...
class SocketMonitor:
    ...
    def remove_process_from_vpn(self, pid: int):  # pylint: disable=redefined-outer-name
        """
    ...
    def forget_process(self, pid: int):  # pylint: disable=redefined-outer-name
        """
...
def main():
    ...
    if is_child_process:
        ...
        with SocketMonitor() as socket_monitor:
            socket_monitor.remove_process_from_vpn(pid)
